...
* Flycheck-Irony
  :PROPERTIES:
  :CUSTOM_ID: flycheck-irony
  :END:

  flycheck irony as syntax checker interface

#+NAME: flycheck
#+BEGIN_SRC emacs-lisp
(defun ome-flycheck-irony-setup ()
(require 'flycheck-irony)
(eval-after-load 'flycheck
  '(add-to-list 'flycheck-checkers 'irony)))
(ome-install 'flycheck-irony)
#+END_SRC
...
* auto-save
  ...
  :CUSTOM_ID:
  :END:
  move auto save and backup files to a safe place.
