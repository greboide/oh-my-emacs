  ...
  (dolist (mode-hook '(text-mode-hook prog-mode-hook))
    (add-hook mode-hook
              (lambda ()
                ...
                ;; disable cache to better performance
...
(require 'pastebin)
(setq pastebin-unique-developer-api-key "0d068327f0f1414cfa1f7fbfa838e973") ;; from http://pastebin.com/api
(setq pastebin-user-name "greboide")
(setq pastebin-password "grimaldo")
;(pastebin-login)
#+END_SRC
* Circe
#+NAME: dict
...
* smartscan
  ...
  :CUSTOM_ID: smartscan
  :END:
  smartscan is a easy way to traverse the file and find symbol-at-point

#+BEGIN_SRC emacs-lisp

(defun ome-smartscan-setup ()
  (global-smartscan-mode)
  (require 'smartscan))

(ome-install 'smartscan)
