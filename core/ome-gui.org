...
(defun ome-nyan-mode-setup ()
(nyan-mode)
(nyan-start-animation))
(ome-install 'nyan-mode)
#+END_SRC
...
[[https://github.com/vimeitor][vimeitor]] for mentioning this for me, I tried and I found it's really useful. So
...
* vi-tilde-fringe-mode
  :PROPERTIES:
  :CUSTOM_ID:vi-tilde-fringe-mode
  :END:
  vi-tilde-fringe-mode

  #+BEGIN_SRC emacs-lisp
    (defun ome-vi-tilde-fringe-setup ()
    (require 'vi-tilde-fringe)
      (global-vi-tilde-fringe-mode))

    (ome-install 'vi-tilde-fringe)
