...
of seeing_is_believing."
  ...
  (define-key ruby-mode-map  (kbd "C-c C-e") 'seeing-is-believing))
(ome-ruby-mode-setup)
#+END_SRC
* Rbenv
  :PROPERTIES:
...
#+RESULTS: rbenv
| :name | rbenv | :after | (progn (ome-rbenv-setup)) |
...
* bundler
  ...
  :CUSTOM_ID: bundler
  :END:
  use bundler install from emacs, perfect for modifying gem file and keeping in
  the loop

#+BEGIN_SRC emacs-lisp

(defun ome-bundler-setup ()
...
* projectile-rails
  :PROPERTIES:
  :CUSTOM_ID: projectile-rails
  :END:
  projectile-rails

#+BEGIN_SRC emacs-lisp

(defun ome-projectile-rails-setup ()
  (add-hook 'projectile-mode-hook 'projectile-rails-on)
  (require 'projectile-rails))

(ome-install 'projectile-rails)
